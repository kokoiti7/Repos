...
namespace CrewAPP {
    ...
    public partial class AZUREDBDataSet : global::System.Data.DataSet {
        ...
        public partial class Crew_ApplicationDataTable : global::System.Data.TypedTableBase<Crew_ApplicationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public Crew_ApplicationRow AddCrew_ApplicationRow(int ApplicationID, Crew_MasterRow parentCrew_MasterRowByFK_Crew_Application_Crew_Application, string FileName, string Filepath, string nvSpare, string Updated) {
...
namespace CrewAPP.AZUREDBDataSetTableAdapters {
    ...
    public partial class Crew_ApplicationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Crew_Application] WHERE (([ApplicationID] = @Original_Applicat" +
                "ionID) AND ([MasterID] = @Original_MasterID) AND ((@IsNull_Updated = 1 AND [Upda" +
                "ted] IS NULL) OR ([Updated] = @Original_Updated)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Crew_Application] ([ApplicationID], [MasterID], [FileName], [Filepath], [nvSpare], [Updated]) VALUES (@ApplicationID, @MasterID, @FileName, @Filepath, @nvSpare, @Updated);
SELECT ApplicationID, MasterID, FileName, Filepath, nvSpare, Updated FROM Crew_Application WHERE (ApplicationID = @ApplicationID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Crew_Application] SET [ApplicationID] = @ApplicationID, [MasterID] = @MasterID, [FileName] = @FileName, [Filepath] = @Filepath, [nvSpare] = @nvSpare, [Updated] = @Updated WHERE (([ApplicationID] = @Original_ApplicationID) AND ([MasterID] = @Original_MasterID) AND ((@IsNull_Updated = 1 AND [Updated] IS NULL) OR ([Updated] = @Original_Updated)));
SELECT ApplicationID, MasterID, FileName, Filepath, nvSpare, Updated FROM Crew_Application WHERE (ApplicationID = @ApplicationID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CrewAPP.Properties.Settings.Default.AZUREDBConnectionString;
        }
        ...
        public virtual int Delete(int Original_ApplicationID, int Original_MasterID, string Original_Updated) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ApplicationID));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_MasterID));
            if ((Original_Updated == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Updated));
            }
        ...
        public virtual int Insert(int ApplicationID, int MasterID, string FileName, string Filepath, string nvSpare, string Updated) {
            ...
            if ((Updated == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(Updated));
            }
        ...
        public virtual int Update(int ApplicationID, int MasterID, string FileName, string Filepath, string nvSpare, string Updated, int Original_ApplicationID, int Original_MasterID, string Original_Updated) {
            ...
            if ((Updated == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Updated));
            }
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_ApplicationID));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_MasterID));
            if ((Original_Updated == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MasterID, string FileName, string Filepath, string nvSpare, string Updated, int Original_ApplicationID, int Original_MasterID, string Original_Updated) {
            return this.Update(Original_ApplicationID, MasterID, FileName, Filepath, nvSpare, Updated, Original_ApplicationID, Original_MasterID, Original_Updated);
        }
    }
    ...
    public partial class Crew_ConfidencialReportTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Crew_ConfidencialReport] WHERE (([ConfidencialD] = @Original_ConfidencialD) AND ([MasterID] = @Original_MasterID) AND ((@IsNull_Filepath = 1 AND [Filepath] IS NULL) OR ([Filepath] = @Original_Filepath)) AND ((@IsNull_Updated = 1 AND [Updated] IS NULL) OR ([Updated] = @Original_Updated)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT ConfidencialD, MasterID, FileName, Filepath, Updated, nvSpare FROM Crew_ConfidencialReport WHERE (ConfidencialD = @ConfidencialD)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ConfidencialD, int Original_MasterID, string Original_Filepath, string Original_Updated) {
            ...
            if ((Original_Updated == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Updated));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.DeleteCommand.Connection.State;
            if (((this.Adapter.DeleteCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int MasterID, string FileName, string Filepath, string Updated, string nvSpare) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MasterID, string FileName, string Filepath, string Updated, string nvSpare, int Original_ConfidencialD, int Original_MasterID, string Original_Filepath, string Original_Updated, int ConfidencialD) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_MasterID));
            if ((Original_Filepath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Filepath));
            }
            if ((Original_Updated == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Updated));
            }
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(ConfidencialD));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MasterID, string FileName, string Filepath, string Updated, string nvSpare, int Original_ConfidencialD, int Original_MasterID, string Original_Filepath, string Original_Updated) {
